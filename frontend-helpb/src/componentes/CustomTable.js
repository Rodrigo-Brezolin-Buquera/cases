...
const columns = [
  ...
  {
    id: "precoFinalAjustado",
    label: "Preço Final Ajustado",
    minWidth: 150,
    editable: false,
  },
  {
    id: "repassePercentual",
    label: "Repasse %",
    minWidth: 80,
    editable: false,
  },
...
export default function CustomTable() {
  ...
  const handleSave = (rowIndex, columnId) => {
    ...
    const productWithFormulas = applyFormulas(updatedProducts[rowIndex]);
    updatedProducts[rowIndex] = productWithFormulas;
                    ...
                    {columns.map((column) => {
                      ...
                      return (
                        <TableCell
                          ...
                          align={column.align}
                          onClick={() =>
                            column.editable && handleEdit(rowIndex, column.id)
                          }
                        >
                          {isEditing ? (
